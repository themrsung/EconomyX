...
public final class CartelMemberRemovedEvent extends OrganizationEvent<Cartel> {
    public CartelMemberRemovedEvent(@NonNull Cartel organization, @NonNull Corporation member) {
        super(organization);
        this.member = member;
    }

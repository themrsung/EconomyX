...
public final class AllianceMemberRemovedEvent extends OrganizationEvent<Alliance> {
    public AllianceMemberRemovedEvent(@NonNull Alliance organization, @NonNull Sovereign member) {
        super(organization);
        this.member = member;
    }

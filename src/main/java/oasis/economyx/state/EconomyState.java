...
public interface EconomyState {
     ...
     *     <li>{@link ConstructionCompany.Constructor}</li>
     ...
     *     <li>{@link Distillery.DistillingCompany}</li>
     ...
     * @return Distillers
     */
    List<oasis.economyx.interfaces.actor.types.services.Distiller> getDistillers();
